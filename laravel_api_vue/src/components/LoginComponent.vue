...
<template>
<form @submit.prevent="console.log(formData)" class="max-w-sm mx-auto">
  <div class="mb-5">
  ...
  <div class="flex items-end mb-5">
    ...
    <span  class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">dont have an account?
